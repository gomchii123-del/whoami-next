...
2. 분석 내용은 철저히 전문적인 분석 시스템, 파동역학, 유전자 은유 등 "체계적이고 현대적인 심리학/명리학적(Systematic & Psychological)" 용어로만 구성하십시오. (주의: 파이썬이나 자바스크립트 등 '실제 소프트웨어 프로그래밍 코드 블록'은 절대 출력하지 마십시오. 비유만 사용할 뿐 진짜 코딩을 하라는 뜻이 아닙니다.)
...
결과는 깔끔하게 읽을 수 있도록 다음 구조를 반드시 엄수하십시오. (10단계 서술은 [Mechanism Logic] 안에 종합하여 장문으로 서술합니다.)
