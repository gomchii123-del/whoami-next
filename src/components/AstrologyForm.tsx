...
export default function AstrologyForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            sessionStorage.setItem('lastAnalysis', JSON.stringify(astrologyData));
            window.location.href = '/result/?type=astrology';
        } catch (err) {
            console.error(err);
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-[2rem] p-6 md:p-10 shadow-xl shadow-sage/5 border border-gray-100 w-full max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="space-y-8">
                <div className="text-center space-y-2">
                    <h2 className="text-2xl md:text-4xl text-foreground font-serif">{t('astrology.formTitle')}</h2>
                    <p className="text-gray-500 text-[17px] font-sans leading-relaxed">{t('astrology.formDesc')}</p>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" required placeholder={t('astrology.birthPlacePlaceholder')} className={`${inputBase} pl-12 pr-4`}
                ...
                >
                    {loading ? (
                        ...
                        <>
                            ...
                            <span>{t('astrology.submitBtn')}</span>
                        </>
                    )}
                </button>
