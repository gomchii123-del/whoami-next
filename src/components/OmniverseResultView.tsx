...
2. 각 단계별로 최소 300~500자 이상의 매우 상세한 서술을 유지하여, 읽는 이가 전율을 느낄 정도의 깊이를 보여주어야 합니다.
3. 전문 술어가 등장할 경우, 그 원리에 대한 철학적 비유와 현대적 해석을 함께 곁들여 주십시오.
...
전문적인 술수를 깊이 있게 교차 사용하며 논리적으로 전개하되, 마치 현자(Wise Guide)가 내담자의 영혼 속을 관통하며 설명하듯, 장엄하고 따뜻하며 감동적인 구어체로 이 긴 여정을 완성하십시오.`.trim();
