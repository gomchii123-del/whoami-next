...
2. '점괘', '방위', '미신', '부적' 등 점술적, 운세적 단어를 철저히 배제하고, "데이터베이스 공학", "운명역학", "에너지 파동", "통계적 궤적", "성격 유전자" 등 논리적이고 학술적인 전문 용어들로 대체하십시오.
...
전문적인 술수를 깊이 있게 교차 사용하며 데이터 공학적으로 전개하되, 마치 현자(Wise Guide)가 내담자의 영혼 속을 관통하며 설명하듯, 장엄하고 압도적인 분량(총 수천 자 이상)으로 이 긴 분석 리포트의 뼈대를 완성하십시오. 아주 길게 뽑아내는 것이 핵심입니다.`.trim();
